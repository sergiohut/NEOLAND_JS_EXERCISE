...
const lookInNumbers = numbers.find(number => number === 100);
console.log(lookInNumbers);
...
const lookInMovies = movies.filter(movie => movie.date === 2010);
console.log(lookInMovies); 
